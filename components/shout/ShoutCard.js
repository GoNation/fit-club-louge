      ...
      <div className="absolute bottom-56  md:bottom-0 left-0 flex justify-center w-full md:w-auto">
        <div className="">
          <button
            ...
            className=" px-4 py-2 uppercase text-white  min-w-[250px]  font-bold tracking-widest flex flex-col items-center md:flex-row md:block bg-primary border-2 px-4 py-2"
          >
